...
<template>
    <div class="login" id="login">
        ...
        <div class="log-bg">
            ...
            <div class="log-logo">Welcome To Us!</div>
            <div class="log-text">@dolo</div>
        </div>
        <div class="log-email">
    ...
    export default {
        ...
        methods:{
            ...
            toLogin(){
                ...
                //   });
                this.$axios
                    .post('http://localhost:8080/commit/login', {
                    ...
                    .then(successResponse => {
                        ...
                        if (successResponse.status === 0) {
                            ...
                            // sessionStorage.setItem("user_id", responseResult.data.id);
                            // sessionStorage.setItem("user_name", responseResult.data.nickname);
                            // sessionStorage.setItem("user_address", responseResult.data.userDetail.address);
                            // sessionStorage.setItem("user_avatar", responseResult.data.userDetail.avatarBase64);
                            //如果是普通用户，去普通页面
                            // if (responseResult.data.user_type == 0) {
                            //     this.$message({
                            //         message: "登录成功 :)",
                            //         type: "success",
                            //     });
                            ...
                            //     //如果是管理员账户，去管理员界面
                            // } else if(responseResult.data.user_type == 1)
                            // {
                            //     this.$message({
                            //         message: "欢迎您，管理员 :)",
                            //         type: "success",
                    ...
                    .catch(failResponse => {console.log('login failed', failResponse);})
...
<style scoped>
    .login{position: fixed; overflow: hidden;left: 50%; margin-left: -250px; top:50%; margin-top: -250px; width: 500px; min-height: 555px; z-index: 10; right: 140px; background: #fff;-webkit-border-radius: 5px;
    ...
    .log-cloud{background-image: url(../../public/login-cloud.png); width: 63px ;height: 40px; position: absolute; z-index: 1}
    ...
    .log-bg{background: url(../../public/login-bg.jpg); width: 100%; height: 312px; overflow: hidden;}
    ...
    .icons{background:url(../../public/icons.png) no-repeat; display: inline-block;}
